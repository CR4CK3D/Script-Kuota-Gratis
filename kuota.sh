...
echo  $red    "|                                   |"
echo  $red    "| Author        : Cracked              |"
echo  $red    "| Contact       : +37121599164      |"
echo  $red    "| My Team       : -.                |"
echo  $red    "| Thanks To     : STANED     |"
echo  $blue "<|======================================|>"
sleep 1
echo " "
...
read -p"╰───────root@cracked-code=•>" Gans;
if [ $Gans = 1 ] || [ $Gans = 01 ]
then
echo $blue"╭──[Berapa GB?]>"
read -p"╰───────root@cracked-code=•>" kntl;
sleep 1
echo $green"╭──[masukan nomor]>"
read -p"╰───────root@cracked-code=•>" memeq;
sleep 1
echo $red "Loading"
sleep 2
